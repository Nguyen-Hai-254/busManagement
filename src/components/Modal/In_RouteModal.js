...
const ModalEditInRoute = ({ license_plate, route_id, movement_direction, No, onHandleEdit }) => {

    const onSubmit = async (e) => {
        e.preventDefault();
        try {
            axios.put(`http://localhost:3001/in_route/edit/${route_id}/${movement_direction}/${No}`, {
...
export default ModalEditInRoute;